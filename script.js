...
let prof = [
    ...
    {id:4, name:"santo", age:"19",profession:"admin"}
]
...
let profTwo = [
    {id:5,name:"jack",age:20,profession:"admin"},
    {id:6, name:"jill",age:21, profession:"admin"},
    {id:7, name:"kevin", age:22,profession:"developer"}
    ]
